...
function copyBase(type, template) {
  ...
  if (entity == null){
    atom.notifications.addError("Please, select a vhdl entity.")
    return
  }
  if (!entity) {
...
function selectAndParseEntity() {
  ...
  const entity = new Parser(editor.getTextInBufferRange(entityRange),editor.getText())

  return {name: entity.name,
          generics: entity.generics,
          ports: entity.ports,
          libraryNoStandard: entity.libraryNoStandard}
}
