...
export default class DocumenterView {
  obj = null;
   constructor({
      ...
      if (this.doc.isAlive() == true){
        this.element.innerHTML += this.doc.html
      }
      else{
        atom.notifications.addInfo('Invalid syntax. Change the code and \
          \ the documentation will be generated automatically. \
          \ VHDL package not suppported.');
      }
