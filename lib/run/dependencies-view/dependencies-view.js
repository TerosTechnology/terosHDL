...
import { generate_svg } from './dependency_graph';
...
export default class DocumenterView {
  ...
  generate(files){
    ...
    console.log(files)
    generate_svg(files,this.openFile,graph).then( async function (dependency_graph_svg) {
      // if (graph.lastChild != null)
      //   graph.removeChild(graph.lastChild);
      // graph.appendChild(dependency_graph_svg);
    });
  }
