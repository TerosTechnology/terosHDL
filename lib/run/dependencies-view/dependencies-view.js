...
export default class DocumenterView {
  obj = null;
   constructor({
      ...
      var active_pane = atom.workspace.getActivePaneItem();
      console.log(active_pane)
      // this.subscriptions = new CompositeDisposable();
      // this.subscriptions.add(active_pane.onDidChangeFlexScale(this.set_new_size))
   ...
   set_new_size(flexScale){
     console.log(flexScale)
   }
