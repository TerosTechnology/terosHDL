...
class CreateRun {
  ...
  createRun() {
    ...
    if (mode == "complex"){
      commandComplex = " --complex"
    } else {
      commandComplex = ""
    }
    var command = commandRun + commandComplex + commandDirectory + commandCore + commandFilename + commandLanguage + commandChecks + commandLibraries
