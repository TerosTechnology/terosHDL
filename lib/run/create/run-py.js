...
class CreateRun {
  ...
  createRun() {
    ...
    modelRunpy['config']['outputPath'] = "/home";
    modelRunpy['config']['name'] = 'hola';
    modelRunpy['src'] = src_files;
    modelRunpy['tb'] = tb_files;
    var runpy = new jsteros.Runpy.runpy(modelRunpy);
    fs.writeFileSync(out_directory[0],runpy.generate());
