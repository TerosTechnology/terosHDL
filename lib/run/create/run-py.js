...
class CreateRun {
  ...
  constructor() {
    ...
    this.checkSynopsis      = this.element.querySelector('.vunit-synopsis');
  ...
  getChecks(){
    let checks = {
      ...
      ieee : this.ieee.checked,
      synopsis : this.synopsis.checked
    }
    return checks
  }
  ...
  createRun() {
    ...
    if (checks.ieee == true){
      commandChecks += " --disable_ieee_warnings"
    }
    if (checks.synopsis == true){
      commandChecks += " --synopsis"
    }
    ////////////////////////////////////////////////////////////////////////////
