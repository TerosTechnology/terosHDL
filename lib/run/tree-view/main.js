...
var viewTreePs ;
var idView = 0;
function treeView(command) {
  //Planteamiento 1: solo hay una visualizacion y se recarga al cerrarla.
  if(viewTreePs == undefined){
    viewTreePs = this.viewTreePs = new TreeView({});
  }
  ...
  if (command === "dependencies")
    viewTreePs.dependenciesGraph();
  else
    atom.workspace.open(this.viewTreePs,{split: 'left'})
