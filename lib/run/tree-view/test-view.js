...
export default class TestView {
   ...
   showError(){
     ...
     this.html.show.tests.style.display   = "none";
     atom.notifications.addWarning('Set up the project correctly before simulating.');
   }
     ...
     for(var i=0;i<tests.length;++i){
       ...
       ///////////////////////////////////////////////////////////////////////
        ...
        btnOut.onclick = function () {
          ...
          var complete_name = tests[i]['classname'] + ":" + tests[i]['name']
          var outputView  = new OutputView(tests[i]['stdout'],complete_name);
