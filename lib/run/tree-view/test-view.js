...
export default class TestView {
   constructor({
      ...
      // sim.runCocotb(testRun).then(this.draw());
   }
   ...
   setTests(){
     ...
     for(var i=0;i<tests.length;++i){
       ...
       ///////////////////////////////////////////////////////////////////////
        ...
        btnOut.className = "btn icon icon-device-desktop btn-warning inline-block-tight";
        btnOut.appendChild(document.createTextNode("Output"));
        cellOutput.appendChild(btnOut);
        ///////////////////////////////////////////////////////////////////////
        // var cellWave   = row.insertCell(5);
        cellOutput.style.padding = "0% 1% 0%"
        ...
        btnWave.onclick = function () {
          var command = "gtkwave " + currentTest['waveform'];
