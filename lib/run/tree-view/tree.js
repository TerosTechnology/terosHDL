...
export default class ProjectManager {
  ...
  */
  async generate_dependency_graph(){
    ...
    this.project_manager.generate_svg(all_sources,this.openFile,this.config['top_level_file']);
  }
  ...
  */
  ...
  set_top_default(){
    this.set_top_from_file(this.config['top_level_file']);
    this.project_manager.set_top_dependency_graph(this.config['top_level_file']);
  }
