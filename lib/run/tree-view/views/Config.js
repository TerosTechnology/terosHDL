module.exports = () => {
   ...
   <atom-panel id="atombrowser-navbar" class="padded native-key-bindings">
     ...
     <div id="tab-test" style="display:none">
       ...
       <section>
         <h2>Top level: </h2>
         <input class='input-text' type='text' id='text-top-level' type='search' placeholder='Top level'>
       </section>
       <section>
         <h2>Working directory: </h2>
         <input class='input-text' type='text' id='text-working-directory' type='search' placeholder='Working directory'>
       </section>
       <p></p>
       <section>
