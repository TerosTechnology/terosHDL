module.exports = () => {
   return  `
      <atom-panel id="atombrowser-navbar" class="padded native-key-bindings">
         ...
         <button style="width: 49%;margin:0px"id="btn-hep"    class="btn btn-info inline-block-tight"><i class="icon icon-info"></i>Help</button>
         <button style="width: 48%;margin:0px"id="btn-check"  class="btn btn-info inline-block-tight"><i class="icon icon-checklist"></i>Check project</button>
         ...
         <button style="width: 32.5%" id="btn-clear"      class="btn"><i class="icon icon-trashcan"></i>Clear</button>
         ...
         <button style="width: 32.5%;margin:0px"id="btn-list-tests"  class="btn btn-list-test inline-block-tight"><i class="icon icon-list-ordered"></i>List</button>
