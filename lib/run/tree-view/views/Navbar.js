module.exports = () => {
   return  `
      <atom-panel id="atombrowser-navbar" class="padded native-key-bindings">
         ...
         <button style="width: 48%"id="btn-save-doc-markdown" class="btn"><i class="icon icon-file-symlink-directory"></i>Generate doc</button>
         ...
         <button style="width: 32%;margin:0px"id="btn-list-tests"  class="btn btn-list-test inline-block-tight"><i class="icon icon-primitive-square"></i>List</button>
       </atom-panel>
   `.trim()
}
