...
export default class TreeView {
   ...
   selectHtml() {
      return {
        ...
        text: {
           ...
           topLevelLabel: this.element.querySelector('#text-top-level-label'),
        ...
        btn: {
          ...
          workingDirectorySelect: this.element.querySelector('#btn-directory-select'),
          // workingDirectoryClear: this.element.querySelector('#btn-directory-clear'),
   ...
   setDefaults(new_config){
     this.html.select.suite.value     = new_config["suite"];
     this.html.select.simulator.value = new_config["tool"];
     this.html.select.language.value  = new_config["language"];
     this.html.text.testName.value         = new_config["name"];
     this.html.text.topLevel.value         = new_config["top_level"];
     this.html.text.workingDirectory.value = new_config["working_dir"];
   }
   setEvents(){
     ...
     this.html.btn.workingDirectorySelect.addEventListener('click', () => this.selectWorkingDirectory())
     // this.html.btn.workingDirectoryClear.addEventListener('click', ()  => this.clearWorkingDirectory())
   ...
   switchGeneral(){
     ...
     let active_suite = this.html.select.suite.value;
     this.show_suite_settings(active_suite);
   }
   switchTest(){
   ...
   selectWorkingDirectory(){
     ...
     dialog.showOpenDialog(
       ...
       function (dir) {
         if(dir == undefined)
           return;
        element.html.text.workingDirectory.value = dir;
       }
     );
   }
   ...
   show_suite_settings(suite){
     if (suite ==  SUITES['VUNIT']){
       this.html.text.topLevel.style.display = "none";
       this.html.text.topLevelLabel.style.display = "none";
     }
     else if (suite ==  SUITES['COCOTB']){
       this.html.text.topLevel.style.display = "block";
       this.html.text.topLevelLabel.style.display = "block";
     }
     else if (suite ==  SUITES['STANDALONE']){
       this.html.text.topLevel.style.display = "block";
       this.html.text.topLevelLabel.style.display = "block";
     }
     else
