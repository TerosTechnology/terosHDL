...
export function runSimulator(buttonCoverage,consolepanel,gtkwave,params,gtkwaveFile,gtkwaveOutput) {
  ...
  if (atom.config.get('TerosHDL.general.simulator') == "ghdl"){
    ...
    if (fs.existsSync(checkPath)) {
      ...
      atom.notifications.addWarning("Please, configure your ghdl path.");
      return;
    }
  }
  if (atom.config.get('TerosHDL.general.simulator') == "modelsim"){
    ...
    if (fs.existsSync(checkPath)) {
      ...
      atom.notifications.addWarning("Please, configure your modelsim-ini path.");
      return;
    }
  }
  if (atom.config.get('TerosHDL.general.simulator') == "modelsim"){
    ...
    if (fs.existsSync(checkPath)) {
      ...
      atom.notifications.addWarning("Please, configure your modelsim path.");
      return;
    }
  }
