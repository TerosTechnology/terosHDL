...
export function pslView(dir){
  ...
  if (fs.existsSync(f)){
    ...
    atom.notifications.addInfo("Your run.py file is not configured correctly to PSL report. Please configure it or deactivate the PSL report. PSL out file must be named psl_coverage.json")
  }
}
