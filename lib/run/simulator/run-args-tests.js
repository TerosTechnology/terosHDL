  ...
  constructor(runpy) {
    ...
    var child = shell.exec(command, {async:true}, function(code, stdout, stderr) {
      ...
      if ( code==0 && fs.existsSync(dir+folderSep+"export.json") ){
        ...
        fs.unlinkSync(dir+folderSep+"export.json")
      }
      else{
        allRow.deleteCell(0)
        allRow.deleteCell(0)
        ...
        tableTitle.insertCell(0).innerHTML = "Error: please, select a correct run.py file or switch to a installed simulator in your system"
      }
