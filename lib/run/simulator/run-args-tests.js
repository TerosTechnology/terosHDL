...
export class testsView {
  constructor(runpy) {
    ...
    var command = modelsim_path + more + modelsim_ini + more + simulator + more + " cd " + dir + more + " python " + file + " --export-json export.json "
    ...
    var child = shell.exec(command, {async:true}, function(code, stdout, stderr) {
      ...
      ////////////////////////////////////////////////////////////////////////////
      if ( code==0 && fs.existsSync(dir+"/export.json") ){
