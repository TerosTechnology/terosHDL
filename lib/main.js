...
import { stopTest } from './run/simulator/runSimulator'
...
export default {
 ...
 repo() {
	 const {shell} = require('electron')
	 shell.openExternal("https://github.com/TerosTechnology")
 },
